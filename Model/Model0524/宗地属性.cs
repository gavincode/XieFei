...
namespace Model
{
    public class 宗地属性
    {
        ...
        public String 核实面积文本
        {
            get
            {
                return String.Format(@"经审查，该宗地申请登记的权属资料齐全且合法有效；地籍调查结果正确，四至清楚无争议，面积准确；权属性质为宅基地使用权，建议对该权利人，进行确权登记，登记面积为  {0}  平方米，其余     平方米为本集体经济组织其他建设用地。", this.批准面积, this.总面积 - ToInt32(this.批准面积));
            }
        }
